...
export class ColorConfig {
	public static readonly themes: {[name: string]: string} = {
		"gembox": `
			:root {
				--page-margin: #050010;
				--editor-background: #050010;
				--hover-preview: #d4af37;
				--playhead: #00ffff;
				--primary-text: #ffffff;
				--secondary-text: #bbaadd;
				--inverted-text: #1a0526;
				--text-selection: rgba(180, 100, 255, 0.99);
				--box-selection-fill: rgba(120, 0, 255, 0.3);
				--loop-accent: #00ffff;
				--link-accent: #ff00ff;
				--ui-widget-background: #220a35;
				--ui-widget-focus: #441565;
				--pitch-background: #1a0526;
				--tonic: #552575;
				--fifth-note: #255575;
				--white-piano-key: #dcb3ff;
				--black-piano-key: #220a35;
